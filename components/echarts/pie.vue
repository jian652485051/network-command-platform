...
export default {
    ...
    methods: {
        drawCharts(){
            ...
            if(this.legend_position == "right-center"){
                lp_right = lp_top ='10px';
                lp_bottom = lp_left = 'auto';
            }
            if(this.legend_position == "left-center"){
                lp_left = lp_top ='10px';
                lp_bottom = lp_right = 'auto';
                pie_position = ['60%', '50%']
            }
            if(this.legend_position == "bottom"){
                lp_right = lp_top = null;
                lp_left = 'center';
                lp_bottom = '10px';
                pie_position = ['50%', '45%']
            }
